...
package dev.tobiasbriones.ep.factura.ui.mainbilling;

import dev.tobiasbriones.ep.factura.domain.model.basket.BasketModel;
import dev.tobiasbriones.ep.factura.domain.model.bill.Bill;
import dev.tobiasbriones.ep.factura.ui.core.rx.AnyObservable;
import dev.tobiasbriones.ep.factura.ui.mainbilling.print.Print;
import dev.tobiasbriones.ep.factura.ui.mainbilling.summary.Summary;
...
import dev.tobiasbriones.ep.factura.ui.mainbilling.about.About;
import dev.tobiasbriones.ep.factura.ui.mainbilling.customer.CustomerCreationDialog;
import dev.tobiasbriones.ep.factura.ui.mainbilling.header.Header;
...
final class MainBillingMediator {
    ...
    void setComponentInput(MainBillingWindow.Input mwInput) {
        ...
        showAboutDialogFn = mwInput::showAboutDialog;
    }
